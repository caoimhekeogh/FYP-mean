(function () {
  ...
  describe('Competency Test List Controller Tests', function () {
    // Initialize global variables
    var CompTestListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _CompTestService_) {
      ...
      CompTestListController = $controller('CompTestListController as vm', {
        $scope: $scope
      });
    ...
    describe('Instantiate', function () {
      ...
      it('should send a GET request and return all CompTests', inject(function (CompTestService) {
        // Set POST response
